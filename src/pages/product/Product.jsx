                ...
                <>
                  <div className="col-lg-6 col-md-6 col-12 mb-3">
                    <div className="card_img_box">
                      <img
                        src={`${path}/image/product/airpods-max-select-${colorStatus}-202011.png`}
                        alt=""
                      />
                    </div>
                          ...
                          <>
                            <div className="card_sml_img_item">
                              <img
                                src={va.url}
                                alt=""
                                onClick={() => setColorStatus(va.color)}
                              />
                            </div>
                          </>
                        );
                  ...
                  <div className="col-lg-6 col-md-6 col-12 mb-3">
                    ...
                    <div className="addto_flex">
                      ...
                      <p className="m-0">
                        only <span>12 items</span> left <br /> Don't Miss it
                      </p>
                    </div>
                    <div className="mt-3 row ml-2">
                      <button className="btn btn-primary mr-1 btn_w btn_bg">
                        Buy Now
                      </button>
                      <button className="btn btn-primary ml-1 btn_w">
                        Add to Cart
                      </button>
                    </div>
                    <div className="card_bo mt-5">
                      <div>
                        ...
                        <p
                          className="m-0 fn_14 ml-4"
                          style={{ textDecoration: "underline" }}
                        >
                          {" "}
                          Enter Your Pincode for delivery availiability
                        </p>
                      </div>
                      <hr />
                      <div>
